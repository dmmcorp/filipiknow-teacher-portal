...
export function TeacherSideNav({
    ...
    const SidebarContents = () => (
        <div className={cn(isMobile ? "mt-0" : " mt-16" ,"bg-[#c6986b]")} style={{ height: `calc(100vh - var(--header-height))`}}>
    ...
    return (
        <div className='mt-16  max-h-[50vh] bg-[#c6986b] overflow-hidden' >
            ...
            {/* Mobile Sheet */}
            <div className={cn("md:hidden fixed top-3 left-4 z-50 bg-[#c6986b] text-white")}>
                <Sheet>
                    ...
                    <SheetContent side="right" className="p-0 w-[300px] z-[9999] bg-[#c6986b] text-white">
